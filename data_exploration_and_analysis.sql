...
-- CRIAR COLUNA "DATE_ID"
ALTER TABLE fato_transactions
ADD Date_ID INT


-- POPULAR COLUNA "DATE_ID"
UPDATE fato_transactions
SET fato_transactions.Date_ID = dim_tempo.Date_ID
FROM fato_transactions
INNER JOIN dim_tempo
ON fato_transactions.Date_Formated = dim_tempo.Date
